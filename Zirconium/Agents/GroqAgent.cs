...
public class GroqAgent : Agent
{
    ...
    public GroqAgent(string model, uint max_output_tokens = 8192, string reasoning_effort = "medium", double temperature = 1, bool enableBrowserSearch=false, bool enableCodeInterpreter=false):base(ApiKeys.Groq()!)
    {
        this.model = model;
